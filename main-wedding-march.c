...
int main()
{
    ...
    while (1) {
        square_am_signal(0.100, 2093);
        usleep(100000);
        square_am_signal(0.100, 2093);
        usleep(100000);
        square_am_signal(0.100, 2093);
        usleep(100000);
        square_am_signal(1.200, 2093);
        usleep(400000);
        square_am_signal(0.100, 2093);
        usleep(100000);
        square_am_signal(0.100, 2093);
        ...
        square_am_signal(0.100, 2093);
        usleep(100000);
        square_am_signal(0.400, 2637);
        usleep(100000);
        square_am_signal(0.100, 2637);
        usleep(100000);
        square_am_signal(0.100, 2637);
        usleep(100000);
        square_am_signal(0.100, 2637);
        ...
        square_am_signal(0.100, 3136);
        usleep(400000);
        square_am_signal(0.800, 2093);
        square_am_signal(0.600, 3951);
        square_am_signal(0.200, 2960);
        square_am_signal(0.400, 3520);
        square_am_signal(0.400, 3136);
        square_am_signal(0.400, 2793);
        square_am_signal(0.400, 2349);
        square_am_signal(0.400, 2093);
        square_am_signal(0.200, 3951);
        square_am_signal(0.200, 2093);
        square_am_signal(0.400, 2349);
        square_am_signal(0.200, 3136);
        square_am_signal(0.200, 2349);
        square_am_signal(0.400, 2637);
        square_am_signal(0.200, 2093);
        square_am_signal(0.200, 2637);
        square_am_signal(0.200, 3136);
        square_am_signal(0.200, 2093);
        square_am_signal(0.200, 2637);
        square_am_signal(0.200, 3136);
